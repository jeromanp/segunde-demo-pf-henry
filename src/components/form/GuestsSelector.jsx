...
export default function GuestsSelector(props){
	...
	const popup_class = `bg-white inset-x-0 absolute bottom-${props.bottom ?? 0} rounded-t-lg`
				...
				<div className="p-3 flex justify-between items-center">
					...
					<div className="w-1/2">
						<Spinner 
							...
							setValue={ e => setGuests({...guests, adults: e})} />
					</div>
				</div>
				...
				<div className="p-3 flex justify-between items-center">
					...
					<div className="w-1/2">
						<Spinner 
							...
							setValue={ e => setGuests({...guests, children: e})} />
					</div>
				</div>
