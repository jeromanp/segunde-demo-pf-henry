					...
					<div className="">
						...
						<div className="mt-2">
							<a 
								...
								<span className="font-semibold tracking-tight">Ver ubicación</span>
							</a>
						</div>
					</div>
					...
					<div className="">
						...
						<div className="text-sm mt-1">
							<div className="flex items-center gap-x-2">
								...
								<a href={`mailto:${data.email}`} className="hover:opacity-80">
									{ data.email }
								</a>
							</div>
							...
							<div className="flex items-center gap-x-2 mt-2">
								...
								<a href={`tel:${data.phone}`} className="hover:opacity-80">
									{ data.phone }
								</a>
							</div>
						</div>
						...
						<div className="flex gap-x-4 mt-2">
							{ data.social.facebook ?
								(<a 
									...
									target="_blank">
									<i class="ri-facebook-box-line text-3xl leading-none hover:opacity-80"></i>
								</a>) : null}
							...
							{ data.social.instagram ? 
								(<a 
									...
									target="_blank">
									<i class="ri-instagram-line text-3xl leading-none hover:opacity-80"></i>
								</a>) : null }
						</div>
					</div>
