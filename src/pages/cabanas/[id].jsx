					...
					<div className="pointer-events-auto">
						...
						<div 
							...
							<div className="bg-black bg-opacity-20 px-3 py-1.5 rounded-lg">
								{ room.capacity > 1 ? `${room.capacity} huespedes` : `${room.capacity} huesped`}
							</div>
							<div className="bg-black bg-opacity-20 px-3 py-1.5 rounded-lg">
								{room.rooms > 1 ? `${room.rooms} dormitorios` : `${room.rooms} dormitorio`} 
							</div>
							<div className="bg-black bg-opacity-20 px-3 py-1.5 rounded-lg">
								{room.beds > 1 ? `${room.beds} camas` : `${room.beds} cama`}
							</div>
							<div className="bg-black bg-opacity-20 px-3 py-1.5 rounded-lg">
								{room.bathrooms > 1 ? `${room.bathrooms} baños` : `${room.bathrooms} baño`}
							</div>
						</div>

						<div 
							className="whitespace-pre-wrap text-sm px-6 mt-5">
							{description}
						</div>

						<div className="mt-10">
							<div className="text-sm font-semibold leading-none">Disponibilidad:{" "}</div>
						...
						<div 
							className="space-x-1 leading-none font-semibold mt-6 flex items-start">
							...
							<span className="text-brand-green text-opacity-60 relative top-1.5">/Día</span>
						</div>
