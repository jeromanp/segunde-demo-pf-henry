export default function handler(req, res) {
  res.status(200).json({ 
		page_title: 'Disfurtá Hueney Ruca!',
		intro: 'Disfruta de un hogar lejos de casa en nuestro hermoso complejo de cabañas completamente equipado con todas las comodidades que necesitas para una estancia confortable y relajante. Ya sea que viajes en pareja o en familia, nuestro alojamiento vacacional es la opción ideal  para unas vacaciones inolvidables.',
		list: [
			{
